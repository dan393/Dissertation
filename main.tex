...
\centering
 \includegraphics[width=0.4\textwidth]{images/building_ann/val_loss_weighted.png}
  \captionof{figure}{Loss minimising on training and test data though epoch training}
