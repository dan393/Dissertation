...
\begin{figure}
    \centering
    \subfigure[Stroke Distribution in the dataset]
    {
        \includegraphics[width=2.5in]{images/building_ann/stroke_countplot.png}
        \label{fig:stroke_count}
    }
    % \\
    \subfigure[Age of stroke patients]
    {
        \includegraphics[width=3.5in]{images/building_ann/stroke_age_distplot.png}
...
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=1\linewidth]{images/building_ann/age_bmi_scatterplot.png}
  \captionof{figure}{A figure}
  \label{fig:test1}
\end{minipage}%
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=1\linewidth]{images/building_ann/smoking_scatterplot.png}
...
\begin{figure}
    ...
    \subfigure[Stroke Distribution in the dataset]
    {
        \includegraphics[width=2.5in]{images/building_ann/age_bmi_scatterplot.png}
        \label{fig:age_bmi_scatterplot}
    }
    % \\
    \subfigure[Age of stroke patients]
    {
        \includegraphics[width=3.5in]{images/building_ann/smoking_scatterplot.png}
        \label{fig:smoking_scatterplot}
    }
%     \caption{Activation functions}
    \label{activation_funtions}
\end{figure}
