...
\begin{minipage}[t]{.7\textwidth}
  ...
  \captionof{figure}{Correlations among all data columns using a balanced subset - smoking status is mapped to binary values}
  \label{fig:heatmap}
\end{minipage}%
...
Surprisingly, a stronger correlation is seen among smoking status and gender (.... fig gender) than among  smoking and strokes or hypertension. Only 0.017\% of those who never smoked suffered a stroke, only slightly better than 0.02\% of those who regularly smoke. Unexpectedly, the highest rate of strokes is for former smokers at 0.03\%.
