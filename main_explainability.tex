...
novelty of exaplinability -whhy and what that means. models are designed and trained to perform well and reduce the loss function not to be explainable to humans in an intitive way
 ...
 The ‘black box’ problem that plagues AI — our inability to peek inside exotic neural networks and understand how they work — represents one of the most urgent moral and %business imperatives of our time. - https://medium.com/@sheldon.fernandez/dark-ai-and-the-promise-of-explainability-part-i-a6b35009a88c
...
\subsection{Overview}
what is explainabilit? define my metrics
what are common appraoches? 
discussion on individual methods with pros and cons.
what can I select for asession on exploratory analysis and on comertical asessment?
...
Christoper Molnar \cite{molnar2019}
