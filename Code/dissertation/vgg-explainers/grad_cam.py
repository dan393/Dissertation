...
# last_conv_layer_name = "17"
# classifier_layer_names = ["18", "22" ]
# model = VGG16()
...
def make_gradcam_heatmap(img_array, model):
    ...
    # over a specific feature map channelCatsDogs-Explainers.ipynb
...
def test_drive_grad(img_array, model):
    """## Let's test-drive it"""
    ...
    # Make model
    # model = tf.keras.models.load_model('catsdogs-vgg')
    ...
    heatmap = make_gradcam_heatmap(
        img_array.reshape(1,250, 250, 3), model)
...
def test_drive_grad_original(img_array, model):
    """## Let's test-drive it"""
    ...
    # Generate class activation heatmap
    heatmap = make_gradcam_heatmap(
        img_array.reshape(1,224, 224, 3), model)
